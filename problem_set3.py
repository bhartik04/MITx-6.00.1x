...
def hangman(secretWord):
    ...
    while noOfGuess>0:
        print("-------------")
        print("You have "+str(noOfGuess)+" letters left.")
        print("Available letters: " + getAvailableLetters(letterGuessed))
        usr=input("Please guess a letter: ")      
            
              
        if usr in letterGuessed:
            print("Oops! You've already guessed that letter: " +getGuessedWord(secretWord,letterGuessed))
            
        elif usr in secretWord:
            letterGuessed.append(usr)
    
            current=getGuessedWord(secretWord,letterGuessed)
        
            print("Good guess: "+current)
