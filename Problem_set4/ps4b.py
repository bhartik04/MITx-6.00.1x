...
def playGame(wordList):
    ...
    while True:
    # Ask player to choose between new deal, redeal the previous hand, or  exit the game
        nre=input('Enter n to deal a new hand, r to replay the last hand, or e to end game: ')
        
        #end game if player chooses  e
        if nre=='e':
            break
        
        
        # Repeat the previous hand if player chooses r
        elif nre=='r':
            try:
                temp=hand
            ...
            # raise an error if there is no previous deal    
            except NameError:
